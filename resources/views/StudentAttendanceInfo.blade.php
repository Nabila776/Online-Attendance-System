...
@section('content')
    <div class="relative min-h-screen flex">
        ...
        <div class="flex-1 p-10 text-2xl font-bold">
            ...
            <p class="text-center py-2">Student report Page</p>
            <div class="w-full px-0 md:px-6 py-12">
                ...
                @foreach ($course->attendances as $report)
                    <div class="w-full flex items-center justify-between border border-gray-200">
                        <div class="text-left text-gray-600 py-2 px-4 font-medium ">{{ $course->courseCode}}</div>
                        <div class="text-left text-gray-600 py-2 px-4 font-medium">{{ $course->CourseTitle }}</div>
